def vercx(fileName):
	...
	# Description: takes file name, reads first line, and returns list of VERCX
...
def v_data(fileName):
	...
	# Description: takes file name and generates a list with all the video sizes in MB
	# Input: full file name
	...
	# create the list
	v_size_list = [int(x) for x in linecache.getline(fileName, 2).split()]
...
def e_data(fileName):
	...
	# Description: takes a file name and generates a list of lists
	# Input: full file name
	# Output: 
...
def r_data(fileName):
	...
	# Description: takes a file name and generates a list of lists describing all the video requests
	# Input: full file name
